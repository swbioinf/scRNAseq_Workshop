...
In this workshop, we used the `qs2` R package for saving and loading the Seurat data. Because the data is often large (~500MB), `qs2` is also used to compress the data, faster than `saveRDS()` does.
