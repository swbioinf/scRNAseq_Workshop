...
Look at the significantly differentially expressed genes, sorted by ascending p-value (most significant first):
...
p <- ggplot(df_long,
  ...
  theme(strip.background = element_rect(fill = "#f5f5f5", colour = "#dddddd"),
