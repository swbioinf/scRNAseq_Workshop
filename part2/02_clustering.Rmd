...
TODO: prompt for what the plots display in regards to cell identities and gene expression differences

## Exercise: Try different cluster settings
...
TODO: Do we have enough information to confirm whether these are clustering by biology and reflect geniune cell types?