...
If you did not complete the exercise above, open `scripts/catchup_script.R` and run the **## Cluster markers** section to set `new.cluster.ids` and `RenameIdents` before continuing.
