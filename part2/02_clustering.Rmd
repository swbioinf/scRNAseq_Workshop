...
Look at the UMAP coloured by clusters, then by `stim` and `ind`. Consider:

- Are any clusters made up almost entirely of cells from one condition or one individual?
- If so, does that reflect biology or could it be a residual technical effect?
