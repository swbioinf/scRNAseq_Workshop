...
gene_list <- c(
  # Broadly upregulated ISGs (reference comparators)
  "ISG15", "MX1",
  # Monocyte-enriched upregulation under IFN-beta
  "APOBEC3A", "CXCL10", "GBP1", "CCL8",
  # Monocyte-specific downregulation under IFN-beta
  "S100A8", "S100A9"
)
